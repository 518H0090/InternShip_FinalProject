...
namespace ShopeeApi.Migrations
{
    ...
    [Migration("20221104033825_updateBillOrder")]
    partial class updateBillOrder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopeeApi.Models.Bill", b =>
                {
            ...
            modelBuilder.Entity("ShopeeApi.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            PasswordHash = new byte[] { 11, 181, 198, 239, 113, 149, 0, 210, 64, 182, 134, 148, 38, 70, 87, 144, 12, 161, 210, 153, 126, 181, 185, 149, 225, 254, 212, 228, 242, 165, 178, 119, 51, 36, 142, 48, 184, 15, 31, 69, 137, 56, 89, 230, 130, 96, 47, 249, 42, 171, 204, 51, 32, 201, 19, 126, 106, 229, 75, 115, 236, 14, 152, 213 },
                            PasswordSalt = new byte[] { 79, 221, 220, 84, 185, 12, 91, 197, 216, 239, 116, 187, 30, 223, 85, 242, 47, 143, 15, 116, 23, 160, 26, 100, 173, 118, 20, 63, 132, 62, 33, 193, 35, 47, 236, 228, 42, 2, 199, 88, 190, 31, 237, 227, 152, 42, 129, 4, 28, 117, 4, 162, 184, 200, 27, 12, 38, 199, 255, 236, 140, 28, 28, 95, 145, 27, 76, 250, 195, 236, 194, 252, 28, 205, 73, 186, 159, 167, 15, 43, 96, 69, 253, 228, 48, 147, 210, 54, 200, 175, 52, 14, 37, 221, 34, 194, 28, 46, 188, 120, 60, 252, 114, 113, 23, 64, 148, 158, 92, 187, 61, 159, 251, 254, 73, 16, 185, 203, 127, 196, 105, 44, 208, 39, 205, 229, 204, 83 },
                            Role = 468255,
                            UserName = "metmoichua"
                        },
                        new
            ...
            modelBuilder.Entity("ShopeeApi.Models.User", b =>
                {
                    ...
                    b.Navigation("SelectFoodRecords");
